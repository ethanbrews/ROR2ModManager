...
namespace ROR2ModManager
{
    class ApplicationSettings
    {
        ...
        public static LocalSettingsValue<bool> ShowExperimentalPages = new LocalSettingsValue<bool>("ShowExperimentalPages", false);
        public static LocalSettingsValue<bool> LaunchGameDirectly = new LocalSettingsValue<bool>("LaunchGameDirectly", false);
